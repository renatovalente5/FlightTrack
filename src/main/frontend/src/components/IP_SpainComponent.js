...
class IP_SpainComponent extends React.Component {
    ...
    async loadData() {
        try {
            PlaneService.getPlanesIpSpain().then((response) => {
                this.setState({
    ...
    render(){
      return(
        <div>
          <h3 className="text-center"> All planes with origin in Spain </h3>
...
export default IP_SpainComponent
